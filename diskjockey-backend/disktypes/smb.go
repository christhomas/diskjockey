...
// SMBDiskType implements DiskType for SMB/CIFS shares

type SMBDiskType struct{}
...
func (SMBDiskType) New(mount *models.Mount) (types.Backend, error) {
...
func (SMBDiskType) Name() string {
	return "samba"
}

func (SMBDiskType) Description() string {
	return "SMB/CIFS network share"
}

func (SMBDiskType) ConfigTemplate() types.DiskTypeConfigTemplate {
	return types.DiskTypeConfigTemplate{
		...
		"share": types.DiskTypeConfigField{
			Type:        "string",
		...
		"root": types.DiskTypeConfigField{
			Type:        "string",
